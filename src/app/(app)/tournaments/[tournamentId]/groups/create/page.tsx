...
//     isLoadingRounds ||
//     isLoadingTeams ||
//     Boolean(initialRoundId && isLoadingGroups);

//   const isSubmitting =
//     isCreatingGroup || isFetchingRounds || isFetchingTeams || isFetchingGroups;
...
//             ? group.teams.map((team) => team.teamId).filter(Boolean)
//             : [];
...
//     isRoundsError ||
//     isTeamsError ||
//     Boolean(initialRoundId && isGroupsError)
//   ) {
//     return (
