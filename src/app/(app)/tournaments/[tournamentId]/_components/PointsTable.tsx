...
//       {data.rows.length === 0 ? (
//         <div className="flex flex-col items-center justify-center px-4 py-12 text-center bg-(--color-bg-card) rounded-2xl border border-(--color-bg-border) shadow-sm">
//           {/* Hierarchical Tree Diagram Graphic */}
//           <div className="relative w-75 h-55 mx-auto mb-8 select-none">
//             {/* Level 1: Round */}
//             <div className="absolute left-0 top-27.5 -translate-y-1/2 w-17.5 bg-white border-2 border-(--color-bg-border) rounded-lg shadow-sm py-1.5 text-xs font-bold text-(--color-navy) z-10">
//               Round
//             </div>

//             {/* Connector: Round -> Groups */}
//             <svg
//               className="absolute left-17.5 top-13.75 w-7.5 h-27.5 text-(--color-bg-border)"
//               width="100%"
//               height="100%"
//             >
//               <path
//                 d="M0 55 H15 V1 H30 M15 55 V109 H30"
//                 fill="none"
//                 stroke="currentColor"
//                 strokeWidth="2"
//               />
...
//             {/* Level 2: Groups */}
//             <div className="absolute left-25 top-13.75 -translate-y-1/2 w-20 bg-(--color-bg-tint) border border-(--color-brand)/30 rounded-lg shadow-sm py-1.5 text-xs font-bold text-(--color-brand) z-10">
//               Group A
//             </div>
//             <div className="absolute left-25 top-41.25 -translate-y-1/2 w-20 bg-(--color-bg-tint) border border-(--color-brand)/30 rounded-lg shadow-sm py-1.5 text-xs font-bold text-(--color-brand) z-10">
//               Group B
//             </div>

//             {/* Connectors: Groups -> Teams */}
//             <svg
//               className="absolute left-45 top-5.5 w-7.5 h-16.5 text-(--color-bg-border)"
//               width="100%"
//               height="100%"
//             >
//               <path
//                 d="M0 33 H15 V1 H30 M15 33 H30 M15 33 V65 H30"
//                 fill="none"
//                 stroke="currentColor"
//                 strokeWidth="2"
//               />
//             </svg>
//             <svg
//               className="absolute left-45 top-33 w-7.5 h-16.5 text-(--color-bg-border)"
//               width="100%"
//               height="100%"
//             >
//               <path
...
//             {/* Level 3: Teams (Group A) */}
//             <div className="absolute left-52.5 top-5.5 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team A
//             </div>
//             <div className="absolute left-52.5 top-13.75 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team B
//             </div>
//             <div className="absolute left-52.5 top-22 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team C
//             </div>

//             {/* Level 3: Teams (Group B) */}
//             <div className="absolute left-52.5 top-33 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team D
//             </div>
//             <div className="absolute left-52.5 top-41.25 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team E
//             </div>
//             <div className="absolute left-52.5 top-49.5 -translate-y-1/2 w-20 bg-(--color-bg-base) border border-(--color-bg-border) rounded py-1 text-[10px] font-semibold text-(--color-text-secondary) z-10">
//               Team F
//             </div>
//           </div>

//           {/* Text Content */}
//           <h3 className="font-(family-name:--font-display) text-lg font-black uppercase tracking-wide text-(--color-navy)">
//             Add Groups
//           </h3>
//           <p className="mt-1 text-sm font-medium leading-relaxed text-(--color-text-secondary)">
