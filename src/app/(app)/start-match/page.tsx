...
//   const isTeamsSelected = Boolean(teamA && teamB);
...
//             className={`${teamA ? "bg-[#0b1727]" : "bg-slate-50"} flex flex-col items-center justify-center p-8  border border-slate-100 rounded-2xl gap-3 shadow-sm active:scale-95 transition-transform`}
//           >
...
//               <h3
//                 className={`${teamA ? "text-slate-50" : "text-slate-900"} font-bold `}
//               >
...
//             className={`${teamB ? "bg-[#0b1727]" : "bg-slate-50"} flex flex-col items-center justify-center p-8  border border-slate-100 rounded-2xl gap-3 shadow-sm active:scale-95 transition-transform`}
//           >
//             <div className="w-12 h-12 bg-slate-100 rounded-full flex items-center justify-center text-slate-400">
//               <Users size={24} />
//             </div>
//             <div className="text-center">
//               <h3
//                 className={`${teamB ? "text-slate-50" : "text-slate-900"} font-bold `}
//               >
